  ...
  checkedAll: function() {
    ...
    if (!this.data.isEditCart) {
      ...
      if (that.data.isMultiOrderModel === 1) {
        that.data.brandCartgoods.forEach(function (v) {
          v.cartList.forEach(function (o) {
            productIdas.push(o.productId);
          });
        });
      } else {
        var productIdqs = that.data.cartGoods.map(function (v) {
          return v.productId;
        });
      }
  ...
  deleteCart: function() {
    ...
    if (that.data.isMultiOrderModel === 1) {
      that.data.brandCartgoods.forEach(function (v) {
        v.cartList.forEach(function (o) {
          if (o.checked == true){
            productId2s.push(o.productId);
          }
        });
      });
    } else {
      productId2s = that.data.cartGoods.map(function (v) {
        if (v.checked == true) {
          return v.productId;
        }
      });
